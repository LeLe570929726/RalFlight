...
BOOST_AUTO_TEST_CASE(Det_1){ 
	Core::Mat4 mat = { -611.39368f, 0.4425795f,  37.025538f,  5.5398580f, 4511.8539f, -0.6679010f, -5.2831158f, -827.74608f,
					   0.57072988f, -833.78383f, 0.3450077f, -68.402962f, 39.544974f, 0.047674122f, -1.1485405f, 566.38983f };
	Core::real32 scalarRes = -77913670737.679953416f;
	BOOST_CHECK_CLOSE_FRACTION(mat.det(), scalarRes, 0.0001f);
}
