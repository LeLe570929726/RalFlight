...
namespace Core {
	...
	public:
		...
		inline Vec4 operator*(real32 scalar) const {
	...
	public:
		...
		inline real32 dot(const Vec4 &vector) const {
			return Vec4::dot(*this, vector);
		}
		inline real32 angle(const Vec4 &vector) const {
