...
namespace Core {
	...
	Vec2 Vec2::add(const Vec2 &vectorA, const Vec2 &vectorB) {
		RF_ALIGN16 float vectorAA[4] = { vectorA.mX, vectorA.mY, 0.0f, 0.0f };
		RF_ALIGN16 float vectorAB[4] = { vectorB.mX, vectorB.mY, 0.0f, 0.0f };
	...
	Vec2 Vec2::mul(const Vec2 &vector, float scalar) {
		RF_ALIGN16 float vectorA[4] = { vector.mX, vector.mY, 0.0f, 0.0f };
		RF_ALIGN16 float vectorB[4] = { scalar, scalar, 0.0f, 0.0f };
	...
	Vec2 Vec2::normalize(const Vec2 &vector) {
		...
		assert(module);
		RF_ALIGN16 float vectorA[4] = { vector.mX, vector.mY, 0.0f, 0.0f };
		RF_ALIGN16 float vectorB[4] = { module, module, 0.0f, 0.0f };
		RF_ALIGN16 float vectorResult[4] = { 0.0f };
		__m128 sseA, sseB, sseResult;
		sseA = _mm_load_ps(vectorA);
		sseB = _mm_load_ps(vectorB);
	...
	float Vec2::cross(const Vec2 &vectorA, const Vec2 &vectorB) {
		RF_ALIGN16 float vectorAA[4] = { vectorA.mX, vectorA.mY, 0.0f, 0.0f };
		RF_ALIGN16 float vectorAB[4] = { vectorB.mY, vectorB.mX, 0.0f, 0.0f };
		RF_ALIGN16 float vectorAResult[4] = { 0.0f };
		__m128 sseA, sseB, sseResult;
		sseA = _mm_load_ps(vectorAA);
		sseB = _mm_load_ps(vectorAB);
	...
	float Vec2::angle(const Vec2 &vectorA, const Vec2 &vectorB) {
		...
		RF_ALIGN16 float vectorAA[4] = { vectorA.mX, vectorA.mY, vectorA.mX, vectorA.mY };
		RF_ALIGN16 float vectorAB[4] = { vectorB.mY, vectorB.mX, vectorB.mX, vectorB.mY };
		RF_ALIGN16 float vectorAResult[4] = { 0.0f };
		__m128 sseA, sseB, sseResult;
		sseA = _mm_load_ps(vectorAA);
		sseB = _mm_load_ps(vectorAB);
	...
	Vec2 Vec2::project(const Vec2 &vectorA, const Vec2 &vectorB) {
		...
		RF_ALIGN16 float vectorAA[4] = { vectorB.mX, vectorB.mY, 0.0f, 0.0f };
		RF_ALIGN16 float vectorAB[4] = { scalar, scalar, 0.0f, 0.0f };
		RF_ALIGN16 float vectorAResult[4] = { 0.0f };
		__m128 sseA;
		__m128 sseB;
		__m128 sseResult;
