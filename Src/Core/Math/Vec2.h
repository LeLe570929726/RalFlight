...
namespace Core {
	...
	public:
		...
		inline Vec2 operator*(real32 scalar) const {
	...
	public:
		...
		inline real32 dot(const Vec2 &vector) const {
			return Vec2::dot(*this, vector);
		}
		inline real32 cross(const Vec2 &vector) const {
			return Vec2::cross(*this, vector);
		}
		inline real32 angle(const Vec2 &vector) const {
	...
	public:
		...
		inline void set(real32(&array)[2]) {
			Vec2::set(*this, array);
		}
